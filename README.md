...
## Funcionalidades
- Busca de produtos: por nome, categoria, preço, disponibilidade, obra;
- Cadastro, login e logout de conta;
- Histórico de compras;
- Adição e remoção de itens do carrinho, uso de cupons;
- Detalhes do produto;
- Pagamento via Pix, cartões de débito/crédito e boleto bancário.
